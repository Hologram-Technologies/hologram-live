...
- Resident `.holo` Wasm execution: load/run/unload sessions over wasmtime with a supervised actor per resident archive.
...
- Resident inference sessions (`weightc enter`) and token streaming on the compatibility APIs.
