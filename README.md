...
fat build. The planner now verifies that recursive child closure—including every child
manifest, delegated capability object, requested capability object, and
layer—under one bounded κ-resolution walk. Capability attenuation and child
execution remain the next M2 slice.
