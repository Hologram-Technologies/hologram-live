...
cross-stage directory serialization. The canonical runtime-tar construction
now passes the local two-build probe; the clean Linux matrix rerun remains the
gate for changing provenance to `reproducible: true`.
