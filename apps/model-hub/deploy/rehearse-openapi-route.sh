...
check "curl /spaces gets the brief"    GET /spaces       200 "# hub.uor.foundation/spaces"   -H "accept: */*"
check "and with the trailing slash"    GET /spaces/      200 "# hub.uor.foundation/spaces"   -H "accept: */*"
check "curl /buckets gets the brief"   GET /buckets      200 "# hub.uor.foundation/buckets"  -H "accept: */*"
check "and with the trailing slash"    GET /buckets/     200 "# hub.uor.foundation/buckets"  -H "accept: */*"
check "curl /docs/ gets the brief"     GET /docs/        200 "# hub.uor.foundation/docs"     -H "accept: */*"
