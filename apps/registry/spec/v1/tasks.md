...
- [x] T036 [US2] P6.T2 (1.25) TLS accept loop on `hyper-util` → `src/tls.rs`, `src/server.rs`. Closes: FR-008 (#103; #108 reloads the certificate without a restart)
