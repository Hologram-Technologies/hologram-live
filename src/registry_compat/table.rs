...
table! {
    ...
    "http.tls.certificate" => Refused(NOT_BUILT),
    "http.tls.key" => Refused(NOT_BUILT),
    "http.tls.minimumtls" => Refused(NOT_BUILT),
    ...
    "http.debug.addr" => Pending("the debug listener arrives with the operations work (FR-S09)"),
    "http.debug.prometheus" => Pending("/metrics arrives with the operations work (FR-S09)"),
    ...
    "health.storagedriver" => Pending("the storage probe arrives with the operations work (FR-S09)"),
